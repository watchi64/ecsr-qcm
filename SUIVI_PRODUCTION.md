...
- **#5, #7, #8, #9, #10, #21, #22** — ces points attendent une **référence externe** (arrêté sur les avertisseurs sonores, arbitrage formateur sur les multiplicateurs de risque, Codes Rousseau Tome A, IISR 5e partie, statistiques ECF). Aucune question de la base ne repose sur les affirmations douteuses : rien à corriger tant que la source n'est pas fournie.
